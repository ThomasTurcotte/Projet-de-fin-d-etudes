...
plt.plot(t, np.sqrt(4*(sigma**2)-(t-1)**2)/(2*np.pi*sigma**2), color='red', label=f'$f(t)=\\frac{{\\sqrt{{4({sigma})^2-(t-1)^2}}}}{{2\\pi ({sigma})^2}}$')
plt.legend()
plt.xlabel('$t$')
